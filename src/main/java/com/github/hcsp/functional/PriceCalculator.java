...
public class PriceCalculator {
    ...
    public static void main(String[] args) {
        ...
        // 不打折
        calculatePrice(PriceCalculator::noDiscount, originalPrice, vipUser);
        // 全场95折
        calculatePrice(PriceCalculator::discount95, originalPrice, vipUser);
        // 只有VIP打95折，其他人保持原价
        calculatePrice(PriceCalculator::onlyVip, originalPrice, vipUser);
    }
    ...
    public static int noDiscount(int price, User user) {
        return price;
    }

    public static int discount95(int price, User user) {
        return (int) (price * 0.95);
    }

    public static int onlyVip(int price, User user) {
        if (user.isVip()) {
            return (int) (price * 0.95);
        } else {
            return price;
