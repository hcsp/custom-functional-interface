...
public class PriceCalculator {
    public static void main(String[] args) {
        ...
        // 全场95折
        discountMoney((price, user) -> (int) (price * 0.95), originalPrice, vipUser);
        // 只有VIP打95折，其他人保持原价
        calculatePrice(
    ...
    public interface DiscountStrategy<T, U, R> {
        R Discount(T t, U u);
    }

    private static int discountMoney(DiscountStrategy<Integer, User, Integer> discountStrategy, int price, User user) {
