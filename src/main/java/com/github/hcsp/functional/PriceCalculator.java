...
public class PriceCalculator {
    ...
    public static int calculatePrice(BiFunction<Integer, User, Integer> discountStrategy, int originalPrice, User user) {
        return discountStrategy.apply(originalPrice, user);
    }
}
