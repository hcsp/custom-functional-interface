...
public class PriceCalculator {
    ...
    public static int calculatePrice(DiscountStrategy<Integer, User> strategy, int price, User user) {
        return strategy.discount(price, user);
    }

    public interface DiscountStrategy<Integer, User> {
        Integer discount(Integer p, User u);
    }
}
